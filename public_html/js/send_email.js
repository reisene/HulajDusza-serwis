...
var _initButtonAnimation = (0, _buttonAnimation["default"])(),
  animateButton = _initButtonAnimation.animateButton,
  resetButton = _initButtonAnimation.resetButton;
...
function _handleSubmit() {
  _handleSubmit = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(event, token) {
    var notification, notificationMessage, formData, emailPattern, mobilePhonePattern, submitButton, uniqueID, data, response, result;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          ...
          mobilePhonePattern = /^[0-9]{9}$/; // Polish mobile phone number pattern: 9 digits
        ...
        case 18:
          ...
          uniqueID = "".concat(Date.now()).concat(Math.floor(Math.random() * 1000000).toString(36)); // Prepare data for sending
          data = new FormData();
          ...
          _context.prev = 28;
          _context.next = 31;
          return fetch('/php/send_email.php', {
            method: 'POST',
            body: data
          });
        case 31:
        ...
        case 38:
          ...
          console.error("Form submission error:", _context.t0.message, _context.t0.stack);
